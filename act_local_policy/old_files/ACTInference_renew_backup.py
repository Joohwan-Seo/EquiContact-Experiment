...
class ACTInference(Node):
    ...
    def __init__(self): 
        ...
        self.activity_sub = self.create_subscription(ActActivity, "act_activity", self.activity_cb, 10)
        
    def init_policy(self, config, reference_frame, reset=False, debug=False):
        self.config = config 
        self.debug = False
