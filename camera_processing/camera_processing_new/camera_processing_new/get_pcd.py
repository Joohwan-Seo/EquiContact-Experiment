...
class PCDSub(Node): 
    ...
    def __init__(self, camera_id, pcd_path): 
    ...
    def get_pcd(self, data): 
        ...
        self.o3d_pcd.points = o3d.utility.Vector3dVector(self.pcd_arr_xyz)
        self.o3d_pcd.colors = o3d.utility.Vector3dVector(colors/255.0)
        o3d.io.write_point_cloud(self.pcd_path, self.o3d_pcd)
...
if __name__=="__main__": 
    ...
    rclpy.init()
    pcd_sub = PCDSub(args.camera_id, args.pcd_path)
    rclpy.spin(pcd_sub)
